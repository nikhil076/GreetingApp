...
package com.bridgelabz.nikhil.controller;
...
import com.bridgelabz.nikhil.Greeting;
...
public class GreetingController {
	 ...
	 * 2. curl localhost:8080/getGreeting?name=Nikhil -w "\n"
	 */
	...
	/**
	 * Execution URL : curl -X POST -H "Content-Type: application/json" -d '{"content":"Nikhil"}' "http://localhost:8080/postGreeting" -w "\n"
	 */
	...
	/**
	 * Execution URL : curl -X PUT localhost:8080/putGreeting/1/?content=Nikhil -w "\n"
	 */
